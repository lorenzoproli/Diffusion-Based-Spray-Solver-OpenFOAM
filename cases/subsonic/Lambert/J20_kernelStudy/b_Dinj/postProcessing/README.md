# Lambert – J20_kernelStudy – b_Dinj – postProcessing
...
- `Lambert_J20_b_Dinj_Lambert_OpenFOAM_Comparison.png`

## tables/

- `Lambert_J20_b_Dinj_profile_OpenFOAM_30d.csv`
- `Lambert_J20_b_Dinj_profile_OpenFOAM_60d.csv`
