# Lambert – J20_kernelStudy – b_0_PCM – postProcessing
...
- `Lambert_J20_b_0_PCM_Lambert_OpenFOAM_Comparison.png`

## tables/

- `Lambert_J20_b_0_PCM_profile_OpenFOAM_30d.csv`
- `Lambert_J20_b_0_PCM_profile_OpenFOAM_60d.csv`
