# Lambert – J10_kernelStudy – kernel-comparison postProcessing
...
- `Lambert_J10_kernel_colormap_D32_30d.png`
- `Lambert_J10_kernel_colormap_D32_60d.png`
- `Lambert_J10_kernel_comparison_D32.png`
- `Lambert_J10_kernel_comparison_D32_30d.png`
- `Lambert_J10_kernel_comparison_D32_60d.png`
- `Lambert_J10_kernel_comparison_Ux.png`
- `Lambert_J10_kernel_comparison_Ux_30d.png`
- `Lambert_J10_kernel_comparison_Ux_60d.png`
- `Lambert_J10_kernel_comparison_all.png`

## tables/

- `Lambert_J10_kernel_error_summary.csv`
