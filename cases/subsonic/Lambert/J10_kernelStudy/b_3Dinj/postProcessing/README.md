# Lambert – J10_kernelStudy – b_3Dinj – postProcessing
...
- `Lambert_J10_b_3Dinj_Lambert_OpenFOAM_Comparison.png`

## tables/

- `Lambert_J10_b_3Dinj_profile_OpenFOAM_30d.csv`
- `Lambert_J10_b_3Dinj_profile_OpenFOAM_60d.csv`
