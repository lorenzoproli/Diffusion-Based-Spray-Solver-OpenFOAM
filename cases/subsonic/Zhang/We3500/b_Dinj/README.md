...
Subsonic crossflow validation case from the Zhang configuration (We3500), used as a kernel-study point for the Diffusion-Based smoothing of the Lagrangian source terms.

## Kernel setting

- Bandwidth label: `b_Dinj` (1 × D_inj)
- `constant/smoothingProperties` → `smoothBandwidth = 0.0016` [m]
...
`~/runs/subsonic/Zhang_cases_cluster/We3500/b_Dinj`
